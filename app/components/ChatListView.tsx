  ...
  if (selectedChat) {
    return (
      <div className="space-y-4 animate-fade-in pb-20 -mt-1 sm:-mt-2">
        ...
        <div className="bg-white rounded-[28px] p-3.5 sm:p-4 border border-gray-200 shadow-sm flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <button
              ...
              className="p-2 rounded-2xl bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold transition-colors cursor-pointer shrink-0"
            >
              <ArrowLeft className="w-5 h-5 text-[#1A1C19]" />
            </button>

            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-10 h-10 rounded-2xl bg-emerald-50 p-0.5 relative shrink-0 border border-emerald-100">
                <Image
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-gray-500 font-semibold truncate">
                  {selectedChat.customerType} · <span className="text-emerald-700 font-bold">Online</span>
                </p>
              </div>
            </div>
          </div>

          <span className="px-2.5 py-1 bg-emerald-50 border border-emerald-200 text-[#0F4C25] font-black text-[10px] rounded-full shrink-0">
            {selectedChat.id}
          </span>
        </div>

        {/* Product & Nego Summary Card Banner */}
        <div className="p-3.5 bg-gradient-to-r from-emerald-900 via-[#0F4C25] to-[#0A381B] text-white rounded-[24px] shadow-sm flex items-center justify-between text-xs">
          <div className="space-y-0.5">
            ...
            <span className="text-[11px] text-emerald-100 font-medium">
              Harga Penawaran: {selectedChat.unitPrice}
            </span>
          </div>
          <div className="text-right">
            <span className="px-2.5 py-1 bg-white/20 backdrop-blur-sm rounded-xl text-[10px] font-black text-white border border-white/20 inline-block">
              Terima Nego
            </span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[28px] border border-gray-200 shadow-sm p-4 space-y-3.5 min-h-[340px] text-xs">
          <div className="text-center text-[10px] text-gray-400 font-bold my-1">
            — Transaksi & Negosiasi Hari Ini —
          </div>

          {/* Message 1 from Buyer */}
          <div className="flex items-start gap-2 max-w-[88%]">
            <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center shrink-0 text-[10px] font-black text-[#0F4C25] border border-emerald-200">
              PB
            </div>
            <div className="space-y-1">
              <div className="p-3.5 bg-[#F8FAF8] border border-gray-200 rounded-2xl rounded-tl-xs shadow-2xs text-gray-800 space-y-1">
          ...
          <div className="flex items-start gap-2 max-w-[88%] ml-auto justify-end">
            <div className="space-y-1 text-right">
              <div className="p-3.5 bg-[#0F4C25] text-white rounded-2xl rounded-tr-xs shadow-2xs space-y-1 text-left">
                <p className="leading-relaxed">
          ...
          {/* Message 3 Buyer Follow-up Offer Card */}
          <div className="flex items-start gap-2 max-w-[88%]">
            <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center shrink-0 text-[10px] font-black text-[#0F4C25] border border-emerald-200">
              PB
            </div>
            <div className="space-y-1">
              <div className="p-3.5 bg-emerald-50/70 border border-emerald-300 rounded-2xl rounded-tl-xs shadow-2xs text-gray-800 space-y-2">
                <div className="flex items-center gap-1.5 text-[#0F4C25] font-black text-[11px]">
                  <Handshake className="w-4 h-4 text-emerald-600" />
                  Penawaran Nego Dari Pembeli:
                </div>
                <div className="p-2.5 bg-white rounded-xl border border-emerald-200 text-[#0F4C25] font-black text-base shadow-2xs">
        ...
        <div className="bg-white rounded-[28px] border border-gray-200 p-3.5 shadow-md space-y-2.5">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl font-black text-xs flex items-center justify-center gap-1.5 shadow-xs cursor-pointer active:scale-95 transition-all"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 bg-emerald-50 hover:bg-emerald-100 text-[#0F4C25] border border-emerald-200 rounded-2xl font-bold text-xs cursor-pointer transition-colors"
            >
              Tawar Balik
            </button>
          </div>
          ...
          <div className="flex items-center gap-2 pt-0.5">
            <input
              ...
              className="flex-1 h-10 px-3.5 bg-[#F8FAF8] border border-gray-200 rounded-2xl text-xs outline-none focus:border-[#0F4C25] font-medium"
            />
            <button
              type="button"
              onClick={() => alert("Pesan terkirim ke pembeli!")}
              className="w-10 h-10 bg-[#0F4C25] hover:bg-[#0A381B] text-white rounded-2xl flex items-center justify-center cursor-pointer shrink-0 shadow-xs active:scale-95 transition-all"
            >
