    ...
    <div className="space-y-5 animate-fade-in pb-10">
      ...
      <div className="space-y-4">
        {purchases.map((item) => (
          ...
          >
            {/* Top Bar: ID & Escrow Status Badge */}
            <div className="flex items-center justify-between border-b border-gray-100 pb-3 text-xs">
              <div className="space-y-0.5">
                <span className="font-extrabold text-[#0F4C25]">{item.id}</span>
                <span className="text-[10px] text-gray-400 font-medium block">
                  {item.transactionDate}
                </span>
              </div>

              <div className="flex items-center gap-1.5 bg-emerald-50 text-[#0F4C25] border border-emerald-100 px-2.5 py-1 rounded-full text-[10px] font-extrabold">
            ...
            <div className="grid grid-cols-3 gap-2 pt-1 text-xs">
              <button
                ...
                className="h-10 bg-gray-50 hover:bg-gray-100 border border-gray-200 text-gray-700 font-extrabold rounded-2xl flex items-center justify-center gap-1 active:scale-95 transition-all cursor-pointer text-[11px]"
              >
              ...
              {!item.isReviewed ? (
                <button
                  ...
                  className="h-10 bg-amber-50 hover:bg-amber-100 border border-amber-300 text-amber-900 font-black rounded-2xl flex items-center justify-center gap-1 active:scale-95 transition-all cursor-pointer text-[11px]"
                >
                  <Star className="w-3.5 h-3.5 fill-amber-400 stroke-amber-500" />
                  <span>Beri Rating</span>
                </button>
              ) : (
                <div className="h-10 bg-emerald-50 border border-emerald-200 text-[#0F4C25] font-extrabold rounded-2xl flex items-center justify-center gap-1 text-[10px]">
              ...
              <button
                ...
                className="h-10 bg-[#0F4C25] hover:bg-[#0A381B] text-white font-black rounded-2xl flex items-center justify-center gap-1 active:scale-95 transition-all cursor-pointer shadow-sm text-[11px]"
              >
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white rounded-[32px] p-5 w-full max-w-[400px] space-y-4 shadow-2xl relative">
            ...
            <form onSubmit={handleReviewSubmit} className="space-y-3.5">
              ...
              <button
                type="submit"
                className="w-full h-11 bg-[#0F4C25] hover:bg-[#0A381B] text-white font-black rounded-2xl flex items-center justify-center gap-2 shadow-md active:scale-95 transition-all text-xs"
              >
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white rounded-[32px] p-5 w-full max-w-[400px] space-y-4 shadow-2xl relative">
            ...
            <button
              ...
              className="w-full h-11 bg-[#0F4C25] text-white font-black rounded-2xl flex items-center justify-center gap-2 text-xs cursor-pointer shadow-md"
            >
