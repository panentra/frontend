...
export default function PemasokOnboardingStep1() {
    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-[#F2F8F3] to-[#E8F3EA] text-[#111827] flex flex-col justify-between p-6 sm:p-8 relative overflow-hidden select-none">
      ...
      <div className="w-full max-w-[380px] mx-auto relative z-10 flex flex-col items-center text-center my-auto pt-4">
        ...
        <div className="mb-6 relative">
          <Image
            src="/assets/budi-bingung.png"
            alt="Budi Bingung Maskot Pemasok"
            width={260}
            height={260}
        ...
        <h1 className="text-2xl sm:text-3xl font-extrabold text-[#111827] leading-tight mb-4 tracking-tight px-1">
          Mengapa sulit mendapatkan pasokan komoditas yang konsisten?
        </h1>

        {/* Body Text */}
        <p className="text-sm sm:text-base text-[#5E635E] leading-relaxed font-normal max-w-[340px] mx-auto px-1">
          Ketiadaan data ketersediaan komoditas dari tingkat petani sering kali membuat jadwal pengadaan usaha Anda terhambat dan tidak menentu.
        </p>
      </div>

      {/* Bottom Action Button (Anchored at the bottom) */}
      <div className="w-full max-w-[360px] mx-auto relative z-10 pb-2 mt-auto">
        <Button size="lg" onClick={() => router.push("/onboarding/pemasok/2")}>
          Lanjut
        </Button>
      </div>
    </div>
